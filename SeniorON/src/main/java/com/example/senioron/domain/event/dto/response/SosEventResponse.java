...
public class SosEventResponse {
    ...
    /** 알림 레코드를 생성한 수신 사용자 수. 실제 전달 성공 수가 아니다. */
    private int receiverCount;

    public static SosEventResponse of(Event event, NotificationPreparationResult result) {
        SosEventResponse response = of(event, result.receiverCount());
