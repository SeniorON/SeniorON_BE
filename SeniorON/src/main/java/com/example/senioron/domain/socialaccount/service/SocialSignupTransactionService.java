...
public class SocialSignupTransactionService {
    ...
    @Transactional
    public SocialSignupResponse signup(SocialSignupRequest request, String providerId, String email) {
        log.info(
        ...
        SocialAccount socialAccount = createSocialAccount(request.getProvider(), providerId, user);
    ...
    private User createUser(SocialSignupRequest request, String socialEmail) {
        String email = blankToNull(socialEmail);
